<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      <!-- Upload Dropbox -->
      <div
        @drag.prevent.stop="drop('drag')"
        @dragstart.prevent.stop="drop('dragstart')"
      ...
      files.forEach((file) => {
        ...
        if (!navigator.onLine) {
          this.uploads.push({
            ...
            currentProgress: 100,
            name: file.name,
            variant: 'bg-red-400 !animate-none',
            icon: 'fa fa-times',
        ...
        const storageRef = storage.ref() // music-ec95b.appspot.com
        const songsRef = storageRef.child(`songs/${file.name}`) // music-ec95b.appspot.com/songs/example.mp3
